...
import { errLogColumn, onIdPaxData, errLogData } from '../one-id-main/data';
...
export default function OneIdErrorHistory() {
  ...
  function turnDisable(flag: string) {
    if (flag == 'ODS') {
    }
  }
  ...
  return (
    <div style={{ width: '1200px' }}>
      ...
      <div>
        ...
        <Typography variant="h4">OneID 에러 이력</Typography>
        <Stack>
          <HorizontalTable>
            <TR>
            ...
            <TR>
              ...
              <TD>
                <TextField
                  ...
                  placeholder="검색어를 입력하세요."
                  value={pnrNum}
                  disabled={oneIdNum === '1' ? true : false}
                  onChange={(e) => onSearchChangeHandler(e, 'pnrNum')}
                />
              </TD>
