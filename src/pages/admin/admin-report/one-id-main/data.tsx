...
const historyColumn: Column[] = [
  { headerName: 'No', field: 'no' },
  { headerName: 'OneID번호', field: 'oneidNo' },
  { headerName: 'OneID변경이유코드', field: 'oneidChgRsnCd' },
  { headerName: '변경전OneID유형코드', field: 'bfChgOneidTypeCd' },
  { headerName: '변경후OneID유형코드', field: 'afChgOneidTypeCd' },
  { headerName: '변경전OneID상태코드', field: 'bfChgOneidSttsCd' },
  { headerName: '변경후OneID상태코드', field: 'afChgOneidSttsCd' },
  { headerName: '변경전OneID최종변경Channel코드', field: 'bfChgOneidFinalChgChnlCd' },
  { headerName: '변경후OneID최종변경Channel코드', field: 'afChgOneidFinalChgChnlCd' },
  { headerName: '변경전OneID최종변경관련번호', field: 'bfChgOneidFinalChgReltNo' },
  { headerName: '변경후OneID최종변경관련번호', field: 'afChgOneidFinalChgReltNo' },
  { headerName: '변경전OneID최종변경UCIID', field: 'bfChgOneidFnlChgUciId' },
  { headerName: '변경후OneID최종변경UCIID', field: 'afChgOneidFnlChgUciId' },
  { headerName: '변경전영문FirstName', field: 'bfChgEngFname' },
  { headerName: '변경후영문FirstName', field: 'afChgEngFname' },
  { headerName: '변경전영문LastName', field: 'bfChgEngLname' },
  { headerName: '변경후영문LastName', field: 'afChgEngLname' },
  { headerName: '변경전휴대전화번호정보', field: 'bfChgMobilePhoneNoInfo' },
  { headerName: '변경후휴대전화번호정보', field: 'afChgMobilePhoneNoInfo' },
  { headerName: '변경전E-Mail주소', field: 'bfChgEmailAdrs' },
  { headerName: '변경후E-Mail주소', field: 'afChgEmailAdrs' },
  { headerName: '변경전출생일자V', field: 'bfChgBirthDtv' },
  { headerName: '변경후출생일자V', field: 'afChgBirthDtv' },
  { headerName: '변경전한글FirstName', field: 'bfChgKorFname' },
  { headerName: '변경후한글FirstName', field: 'afChgKorFname' },
  { headerName: '변경전한글LastName', field: 'bfChgKorLname' },
  { headerName: '변경후한글LastName', field: 'afChgKorLname' },
  { headerName: '변경전영문Soundex값', field: 'bfChgEngNmSoundexValue' },
  { headerName: '변경후영문Soundex값', field: 'afChgEngNmSoundexValue' },
  { headerName: '변경전휴대전화정보Hash값', field: 'bfChgMblfonNoInfoHashVlu' },
  { headerName: '변경후휴대전화정보Hash값', field: 'afChgMblfonNoInfoHashVlu' },
  { headerName: '변경전E-Mail주소Hash값', field: 'bfChgEmailAdrsHashValue' },
  { headerName: '변경후E-Mail주소Hash값', field: 'afChgEmailAdrsHashValue' },
  { headerName: '변경전여권국적ISO3Letter국가코드', field: 'bfChgPpNtnltyIsoL3CtrCd' },
  { headerName: '변경후여권국적ISO3Letter국가코드', field: 'afChgPpNtnltyIsoL3CtrCd' },
  { headerName: '변경전여권만료일자V', field: 'bfChgPassportExpireDtv' },
  { headerName: '변경후여권만료일자V', field: 'afChgPassportExpireDtv' },
  { headerName: '최초생성일시', field: 'creationDate' },
  { headerName: '최종갱신일시', field: 'lastUpdateDate' },
];
const masterColumn: Column[] = [
  { headerName: '출생일자V', field: 'birthDatev' },
  { headerName: '최초생성일시', field: 'creationDate' },
  { headerName: 'E-Mail주소', field: 'emailAddress' },
  { headerName: 'E-Mail주소Hash값', field: 'emailAdrsHashValue' },
  { headerName: '영문FirstName', field: 'engFname' },
  { headerName: '영문LastName', field: 'engLname' },
  { headerName: '영문명Sounddex값', field: 'engNmSoundexValue' },
  { headerName: '최종갱신일시', field: 'finalInqDtim' },
  { headerName: '한글FirstName', field: 'firstNameK' },
  { headerName: '한글LastName', field: 'lastNameK' },
  { headerName: '최종갱신일시', field: 'lastUpdateDate' },
  { headerName: '휴대전화정보Hash값', field: 'mobilePhoneNoInfoHashVlu' },
  { headerName: '휴대전화정보', field: 'mobilePhoneNumberInfo' },
  { headerName: '복수여권여부', field: 'multiplePassportYn' },
  { headerName: 'No', field: 'no' },
  { headerName: 'OneID최종변경Channel코드', field: 'oneidFinalChgChnlCd' },
  { headerName: 'OneID최종변경관련코드', field: 'oneidFinalChgRelateNo' },
  { headerName: 'OneID최종변경UCIID', field: 'oneidFinalChgUciId' },
  { headerName: 'OneID번호', field: 'oneidNo' },
  { headerName: 'OneID등록Channel코드', field: 'oneidRegisChnlCd' },
  { headerName: 'OneID상태코드', field: 'oneidSttsCd' },
  { headerName: 'OneID유형코드', field: 'oneidTypeCd' },
  { headerName: '성별코드', field: 'sexCode' },
  { headerName: '성별등록Channel코드', field: 'sexRegisChnlCd' },
  { headerName: '자택전화번호정보Hash값', field: 'homePhoneNoInfoHashValue' },
  { headerName: '휴대전화번호정보Hash값', field: 'mobilePhoneNoInfoHashVlu' },
  { headerName: 'E-Mail주소Hash값', field: 'emailAdrsHashValue' },
  { headerName: '자택전화번호정보', field: 'homePhoneNumberInfo' },
...
const mobMasterColumn: Column[] = [
  ...
  { headerName: '영문FirstName', field: 'firstNameE', colSpan: 0.8 },
  { headerName: '영문LastName', field: 'lastNameE', colSpan: 0.8 },
  { headerName: '휴대전화번호정보', field: 'phoneNum', colSpan: 0.8 },
  { headerName: 'E-Mail주소', field: 'eMailAdr', colSpan: 1.2 },
  { headerName: '출생일자V', field: 'birth', colSpan: 0.8 },
  { headerName: '한글FirstName', field: 'firstNameK', colSpan: 0.8 },
  { headerName: '한글LastName', field: 'lastNameK', colSpan: 0.8 },
...
const relationColumn: Column[] = [
  { headerName: 'No', field: 'no' },
  { headerName: '병합TargetOneID번호', field: 'mergeTargetOneidNo' },
  { headerName: '병합SourceOneID번호', field: 'mergeSourceOneidNo' },
  { headerName: 'Skypass회원번호', field: 'skypassNum' },
  { headerName: 'Skypass회원번호(PAX)', field: 'skypassNumPax' },
  { headerName: '영문FirstName', field: 'engLname' },
  { headerName: '영문LastName', field: 'engFname' },
  { headerName: '한글FirstName', field: 'korLname' },
  { headerName: '한글LastName', field: 'korFname' },
  { headerName: 'E-Mail주소', field: 'emailAddress' },
  { headerName: '휴대전화번호정보', field: 'mobilePhoneNumberInfo' },
  { headerName: '출생일자V', field: 'birthDatev' },
  { headerName: '최초생성일시', field: 'creationDate' },
  { headerName: '최종갱신일시', field: 'lastUpdateDate' },
  { headerName: 'OneID병합상태코드', field: 'oneidMergeSttsCd' },
  { headerName: 'Skypass회원번호', field: 'skypassMemberNumber' },
];
...
const ctiVocColumn: ColumnChild[] = [
  ...
  { headerName: 'OneID미연결건수', field: 'totalCntCaseClose' },
  {
...
const oneIdDailyColumn: ColumnChild[] = [
  { headerName: 'No', field: 'no', colSpan: 1 },
  { headerName: '일자', field: 'aggrDate', colSpan: 1 },
  {
    headerName: 'PNR',
    field: '',
    colSpan: 7,
...
const oneIdSameColumn: Column[] = [
  { headerName: 'No', field: 'no' },
  { headerName: 'S-OneID FirstName', field: 'oneIdSourceEngFname' },
  { headerName: 'S-OneID LastName', field: 'oneIdSourceEngLname' },
  { headerName: 'T-OneID Skypass', field: 'oneIdSourceSkypassNo' },
  { headerName: 'T-OneID FirstName', field: 'oneIdTargetEngFname' },
  { headerName: 'T-OneID LastName', field: 'oneIdTargetEngLname' },
  { headerName: 'T-OneID OneID', field: 'oneIdTargetOneId' },
  { headerName: 'T-OneID SkypassNO', field: 'oneIdTargetSkypassNo' },
  { headerName: 'T-OneID paxMapping OneID', field: 'sourcePaxMappingOneIdNo' },
  { headerName: 'S-OneID paxMapping PnrNo', field: 'sourcePaxMappingPnrNo' },
  { headerName: 'S-OneID paxMapping Uci-IDNo', field: 'sourcePaxMappingUciIdNo' },
];
