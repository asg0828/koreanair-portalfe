      ...
      <Stack direction="Vertical" gap="MD">
          ...
          <HorizontalTable>
            ...
            <TR>
              ...
              <TD colSpan={2}>
                <TextField className="width-100" readOnly defaultValue={'12345'} id="id" onChange={onchangeInputHandler}/>
              </TD>
              <TH required colSpan={1} align="right">
                Feature 타입
              </TH>
              <TD colSpan={2} align="left">
                <TextField className="width-100" readOnly value={'Self-Feature'}  id="dataType" onChange={onchangeInputHandler}/>
              </TD>
            </TR>
            {/* <TR>
            ...
            <TR>
              <TH colSpan={1} required align="right">산출 로직</TH>
              <TD colSpan={5.01}>
                <TextField className="width-100" id="description" multiline onChange={onchangeInputHandler}/>
              </TD>
            </TR>
